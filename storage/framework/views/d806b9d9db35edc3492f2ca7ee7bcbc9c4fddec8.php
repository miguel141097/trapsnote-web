<html>
  ...
  <body>
  	...
  	<div class="box1">
  		...
  		<img src="images/logoRetocado.jpg" class="logotipo">
    ...
    <div id="box2"> ¿No tienes cuenta?
    	...
    	<button type="button" onclick="location = 'CrearSesion'">Registrate</button>
    ...
    <?php
      ...
      if($_POST){
          ...
          include 'objetos/CapturaIniciar';
          ...
          if($datos != "Error"){
            echo "<script language='javascript'>window.location='salidas/action_iniciar_sesion'</script>";
          }
